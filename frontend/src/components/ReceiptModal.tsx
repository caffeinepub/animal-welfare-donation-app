...
import type { Donation, AnimalCampaign } from '../backend';
...
export default function ReceiptModal({ open, onClose, donation, campaigns, donorName }: ReceiptModalProps) {
      ...
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <div className="flex items-center gap-2 mb-1">
            ...
            <DialogTitle className="font-serif text-lg">Donation Receipt</DialogTitle>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="bg-accent/40 rounded-xl p-4 space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold text-foreground text-right max-w-[160px]">{campaignTitle}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Amount</span>
              <span className="font-bold text-primary text-lg">{formatCurrency(Number(donation.amount) / 100)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Date</span>
              <span className="font-semibold text-foreground">{formatDate(donation.timestamp)}</span>
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 bg-muted rounded-lg px-3 py-2">
              <code className="text-xs text-foreground flex-1 truncate font-mono">{donation.referenceId}</code>
