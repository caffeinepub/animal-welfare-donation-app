...
export default function RecentDonors({ donations, campaignId, isLoading }: RecentDonorsProps) {
        ...
        {campaignDonations.map((donation, idx) => {
          ...
          return (
            <div key={idx} className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-primary">{formatCurrency(Number(donation.amount))}</span>
            </div>
          );
        })}
      </CardContent>
