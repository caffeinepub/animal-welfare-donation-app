...
export default function Home() {
  ...
  const campaigns = useMemo(() => {
    ...
    return base.filter((c) => {
      const matchesType = selectedType === 'All' || c.animalType.toLowerCase().includes(selectedType.toLowerCase());
  ...
  }, [activeCampaigns, allCampaigns, selectedType, selectedStatus, searchQuery]);
    ...
    <div className="max-w-6xl mx-auto px-4 pb-12">
      ...
      <div className="relative -mx-4 mb-8 overflow-hidden">
        <img
          ...
          alt="PawFund - Help Animals in Need"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          ...
          <p className="text-sm md:text-base text-foreground/80 mt-1 max-w-lg">
            Support animal welfare campaigns and make a difference in the lives of animals who need you.
          </p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          ...
          <h3 className="font-serif font-bold text-lg text-foreground">No campaigns found</h3>
